...
- **OAAB_Data** (`oaab-data`) — status: `planned`, engine: `mwse`, cross-edition: `equivalent-needed`. Reason: Initial candidate placeholder entry.
- **Kogoruhn Expanded** (`kogoruhn-expanded`) — status: `planned`, engine: `mwse`, cross-edition: `mwse-only`. Reason: Initial candidate placeholder entry.
- **Caldera Mine Expanded** (`caldera-mine-expanded`) — status: `planned`, engine: `mwse`, cross-edition: `equivalent-needed`. Reason: Initial candidate placeholder entry.

## Archives, Evidence, and Retrospective Dread
- **Divine Dagoths** (`divine-dagoths`) — status: `planned`, engine: `mwse`, cross-edition: `equivalent-needed`. Reason: Initial candidate placeholder entry.

## Ash, Weather, and Distance
- **Glow in the Dahrk** (`glow-in-the-dahrk`) — status: `planned`, engine: `mwse`, cross-edition: `equivalent-needed`. Reason: Initial candidate placeholder entry.
- **Parasol Particles** (`parasol-particles`) — status: `planned`, engine: `mwse`, cross-edition: `equivalent-needed`. Reason: Initial candidate placeholder entry.
...
- **OAAB Dwemer Pavements** (`oaab-dwemer-pavements`) — status: `planned`, engine: `mwse`, cross-edition: `equivalent-needed`. Reason: Initial candidate placeholder entry.
...
## Faith, Temple, and False Divinity
- **Red Wisdom - An Ashlander Prophecy** (`red-wisdom-an-ashlander-prophecy`) — status: `planned`, engine: `mwse`, cross-edition: `equivalent-needed`. Reason: Initial candidate placeholder entry.
...
- **Morrowind Optimization Patch** (`morrowind-optimization-patch`) — status: `planned`, engine: `mwse`, cross-edition: `equivalent-needed`. Reason: Initial candidate placeholder entry.
